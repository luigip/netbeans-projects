...
public class Tools {
    ...
    public static void framePanel(JPanel panel, String title){
    ...
    public static void setLook(String lookFeelName){
        try {
            UIManager.setLookAndFeel(lookFeelName);
        } catch (Exception e) {
