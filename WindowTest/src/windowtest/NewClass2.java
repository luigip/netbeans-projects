...
//        new P003_primes().run();
        ...
        new NewClass2().buildFrames();
        System.out.println("windowtest");
        System.out.printf("Took %,f seconds %n", (System.nanoTime()-startTime)/1000000000d);
    }
    void buildFrames(){
...
//
    ...
    class ButtonPanel extends JPanel {
        ...
        public ButtonPanel() {
            ...
            setLayout(layout);
            try {
                classList = (ArrayList) getClasses(this.getClass().getPackage().getName());
            } catch (Exception e) {
                e.printStackTrace();
            }
