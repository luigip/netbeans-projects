...
public class FilterTestsGrey extends JPanel {

    BufferedImage[] spot_ARGB = new BufferedImage[2];
    
    public FilterTestsGrey() {

        spot_ARGB[0] = new BufferedImage(50, 50, BufferedImage.TYPE_BYTE_GRAY);
        spot_ARGB[1] = new BufferedImage(50, 50, BufferedImage.TYPE_BYTE_GRAY);
