...
public class DigitalClock extends Application {
    ...
    private void init(Stage primaryStage) {
        ...
        ImageView background = new ImageView(new Image(getClass().getResourceAsStream("/clock/DigitalClock-background.png")));
        // add digital clock
        clock = new Clock(Color.RED, Color.rgb(50,50,50));
        clock.setLayoutX(45);
        clock.setLayoutY(186);
        clock.getTransforms().add(new Scale(0.83f, 2f, 0, 0));
